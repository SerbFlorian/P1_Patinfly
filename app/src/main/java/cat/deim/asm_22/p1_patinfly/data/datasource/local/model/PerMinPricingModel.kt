...
import cat.deim.asm_22.p1_patinfly.domain.models.PricingMinRateDomain
 ...
 *
 * @property start El valor inicial para la tarifa mínima.
 * @property rate La tarifa mínima aplicada.
 * @property interval El intervalo en el que se aplica la tarifa mínima (por ejemplo, cada X unidades de tiempo o distancia).
 */
